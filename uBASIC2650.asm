...
CLRV:
        ...
        BSTA,UN SETUP_RND       ; initialize seed
...
; --- External Entry Point Preserved Intact ---
DRT_GO:
...
; note TAB and CHR$ are handled by PRINT as only meaningful there
FUNC_TAB:
