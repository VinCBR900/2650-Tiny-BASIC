...
PARSE_VAR_SAVE:
        ...
        ADDI,R0 A'A'                     ; RESTORE the original ASCII character
        STRA,R0 SC0
...
DLS_NL:
        ZBSR *VINC_TMP                    ; skip over CR char
        ZBSR *VPRT_CRLF
DLS_LP:
...
; Clobbers: R0, R1, R3, SC0, SC1 (R2 saved/restored internally; TMP is NOT
;   clobbered - DO_LIST relies on that to walk TMP directly)
PRINT_S16:
