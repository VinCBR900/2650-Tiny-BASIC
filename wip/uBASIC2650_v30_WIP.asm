...
;   Deepest path: DR_LP(1)   STMT_EXEC(2)   DO_IF(2)   PARSE_EXPR(3)
;        PARSE_FACTOR(4)   PARSE_S16(5)   PARSE_U16(6)   [inline] SP=6. Safe.
;   With THEN body: DR_LP(1)   SE(2)   DO_IF(2)   SE(3)   DO_PRINT(3)
;        PARSE_EXPR(4)   APPLY_OP(5)   MUL16(6)   ABS_TMP(6,tail) SP=6. Safe.
;
...
;   V3.0  WIP 2026-05-30
;
;   STATUS: WORK IN PROGRESS — DO NOT USE FOR PRODUCTION
;
;   CHANGE: Replaced shunting-yard PARSE_EXPR (737B) + GET_PREC/APPLY_OP (185B)
...
;
;   KNOWN BUG: Interpreter hangs on first PRINT statement.
;             Root cause under investigation: TEMPRETH/TEMPRETL ($1660/$1661)
;             appear corrupted before SWRETURN fires for the first time.
;             Suspect: RESET startup does not initialise these RAM locations,
;             and something in the boot path writes garbage to $1660/$1661
;             before PARSE_EXPR runs. Next step: trace RESET→REPL→DO_PRINT
;             to find what writes to $1660/$1661 before first PRINT.
;
;   RAM CHANGES vs v28:
...
;     Unchanged: SWSP($162D), SWSTK/SWBASE($162E/$1640), TEMPRETH($1660),
;              TEMPRETL($1661), R3SAVE($1662), IBUF($1663), VARS($16A3)
;
;   SIZE: Interpreter ROMEND moved $1229→$1118 = 273 bytes saved.
;         Total assembled unchanged (5838B) due to ORG PROG=$16D7 gap.
;
...
; =============================================================================
         ...
         DB $00,$14,$50,$52,$49,$4E,$54,$20,$22,$2D,$2D,$20,$75,$42,$41,$53,$49,$43,$20,$32,$36,$35,$30,$20,$56,$32,$2E,$35,$20,$53,$68,$6F,$77,$63,$61,$73,$65,$20,$2D,$2D,$22,$0D  ; 20 PRINT "-- uBASIC 2650 V2.5 Showcase --" 
